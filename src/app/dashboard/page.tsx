...
export async function dashboardPage(){
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-6">
            ...
            <form onSubmit={handleCreateJob} className="bg-card border border-border rounded 2xl space-y-4">
                {message &&(
                ...
                <input placeholder="Salary" type={salary} onChange={(e)=>setSalary(e.target.value)} />
