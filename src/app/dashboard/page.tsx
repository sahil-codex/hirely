    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      >
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-primary py-2 rounded-xl text-white hover:opacity-90 transition"
        >
        ...
        {loadingJobs ? (
          ...
          <div className="grid gap-4">
            {jobs.map((job) => (
              <div
                key={job.id}
                className="bg-card border border-border rounded-xl p-5 hover:border-primary/50 transition space-y-3"
              >
                {/* Job Information */}
          ...
          <div className="bg-card border border-border rounded-2xl p-6 w-full max-w-sm text-center shadow-xl">
            ...
            <div className="flex gap-3 mt-6">
              <button
                ...
                className="flex-1 border border-border rounded-lg py-2 text-gray-300 hover:bg-muted"
              >
                Cancel
              </button>
              ...
              <button
                ...
                className="flex-1 bg-red-500 rounded-lg py-2 text-white hover:bg-red-600"
              >
                Delete
              </button>
            </div>
